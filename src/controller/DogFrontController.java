...
public class DogFrontController extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(command.equals("/dogCartAdd.dog")) {//'새로운 개 상품 정보 등록을 처리하는' 요청이면						
		...
		else if(command.equals("/dogCartList.dog")) {//장바구니 목록보기					
		...
		else if(command.equals("/dogCartSearch.dog")) {//최하 최고가격으로 장바구니 항목검색			
